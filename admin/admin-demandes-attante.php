...
<html lang="en">
    <head>
        ...
        <title>Demandes en attante</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">les demandes en attante</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Demandes</li>
            							<li class="active">Demandes en attante</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Liste des  Demandes en attante</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
<a href="delete-demandes.php?demandeid=<?php echo $rows['idpending'];?>"><i class="fa fa-minus" title="supprimer"></i> </a>
