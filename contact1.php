    ...
    <div class="contact_section layout_padding">
      <div class="container-fluid">
        <div class="contact_text"><b>CONTACTEZ NOUS !</div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mail_section">
                ...
                <input type="" class="mail_text" placeholder="Numero de telephone" name="Phone Number">
                ...
                <div class="Locations_text"><img src="images/map-icon.png"><span class="map_icon">Marrakech 321</span></div>
                <div class="Locations_text"><img src="images/call-icon.png"><span class="map_icon">+212 612345678</span></div>
